...
is the roadmap. A GEO pack also ships competitor comparison and score-over-time tracking, which
siteready now also has (`compare`, `monitor` — see [CLI reference](cli-reference)).
