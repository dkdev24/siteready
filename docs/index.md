...
own scanners, not from a model grading itself; fixes are real code, applied idempotently, verified
cross-platform in CI; and the local loop shows you the before/after diff before anything deploys.
